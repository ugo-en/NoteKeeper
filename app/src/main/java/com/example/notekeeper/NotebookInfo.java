...
public final class NotebookInfo implements Parcelable {
    private final String mCourseId;
    private final String mTitle;
    private final List<ModuleInfo> mModules;

    public NotebookInfo(String courseId, String title, List<ModuleInfo> modules) {
        mCourseId = courseId;
        mTitle = title;
        mModules = modules;
    }

    private NotebookInfo(Parcel source) {
    ...
    public static final Creator<NotebookInfo> CREATOR =
            new Creator<NotebookInfo>() {

                @Override
                public NotebookInfo createFromParcel(Parcel source) {
                    return new NotebookInfo(source);
                }

                @Override
                public NotebookInfo[] newArray(int size) {
                    return new NotebookInfo[size];
                }
            };
